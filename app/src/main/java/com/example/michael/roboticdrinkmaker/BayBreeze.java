...
public class BayBreeze extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bay_breeze);
        ...
        query.getInBackground("H1TohwVAuG", new GetCallback<ParseObject>() {
    ...
    private void setupMessageButton() {
        ...
        Button messageButton1 = (Button) findViewById(R.id.make_baybreeze);
        ...
        messageButton1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent messageButtonActivity = new Intent(BayBreeze.this, ListViewExampleActivity.class);
                BayBreeze.this.startActivity(messageButtonActivity);
            }
        });
